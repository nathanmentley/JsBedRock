...
(function () {
    ...
    JsBedRock.Utils.ObjectOriented.ObjectDefBuilder = function (_constructor) {
    ...
    JsBedRock.Utils.ObjectOriented.Inherit = function (_cls, _superCls) {
    ...
    JsBedRock.Utils.ObjectOriented.Implement = function (_cls, _interface) {
