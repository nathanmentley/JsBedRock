...
(function (asm) {
	asm.OnLoad(function () {
        JsBedRock.Types.Object = (function () {
            ...
            classDef.prototype.Base = function () {
            ...
            classDef.prototype.Name = "Object";
    
            JsBedRock.Utils.ObjectOriented.Implement(classDef, JsBedRock.Types.Interface);
